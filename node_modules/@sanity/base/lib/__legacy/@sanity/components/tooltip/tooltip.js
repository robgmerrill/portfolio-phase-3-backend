...
function Tooltip(props) {
  ...
  if (!isOpen || props.disabled) {
    return props.children || /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null);
  }

  return /*#__PURE__*/_react.default.createElement(_components.LegacyLayerProvider, {
    zOffset: "tooltip"
  }, /*#__PURE__*/_react.default.createElement(TooltipChildren, _extends({}, props, {
    setIsOpen: setIsOpen
  })));
}

function TooltipChildren(props) {
  var allowedAutoPlacements = props.allowedAutoPlacements,
      ...
      tone = props.tone,
      restProps = _objectWithoutProperties(props, ["allowedAutoPlacements", "children", "className", "content", "disabled", "fallbackPlacements", "placement", "portal", "setIsOpen", "tone"]);
  ...
  var popperNode = /*#__PURE__*/_react.default.createElement("div", _extends({}, restProps, {
    ...
    style: _objectSpread(_objectSpread({}, popper.styles.popper), {}, {
      zIndex
    })
